...
function SideMenu() {
  ...
  return (
    <div className="h-full flex-col justify-between bg-gradient-to-b from-orange-400 to-yellow-600 hidden lg:flex shadow-lg">
      <div className="px-6 py-9 " >
        <nav aria-label="Main Nav" className="mt- flex flex-col space-y-2">
          <Link
            to="/"
